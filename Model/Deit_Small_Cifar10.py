...
class Deit_Cifar10(nn.Module):
    def __init__(self, num_classes=10, input_size=32, weight_path=None, img_size=32, patch_size=4,
                 in_chans=3, embed_dim=384, depth=12, num_heads=6, mlp_ratio=4., qkv_bias=True,
                 drop_rate=0., attn_drop_rate=0.):
        super(Deit_Cifar10, self).__init__()
    ...
    def Save_Model_Weight(self, weight_path):
        ...
        save_path = os.path.join(weight_path, 'deit_cifar10')
